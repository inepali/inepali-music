		...
		if(_admob){
			...
			if(ionic.Platform.isAndroid()) {
				_admobid = { // for Android
				    banner: 'ca-app-pub-8818301262480718/3671525012',
				    interstitial: 'ca-app-pub-8818301262480718/5148258217'
				};
			}

		   	if(ionic.Platform.isIOS()){
		    	_admobid = { // for iOS
		    	    banner: 'ca-app-pub-8818301262480718/8241325417',
		    	    interstitial: 'ca-app-pub-8818301262480718/9718058611'
		    	};
		   	}
